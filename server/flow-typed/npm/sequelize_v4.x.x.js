...
declare module "sequelize" {
    ...
    declare class BelongsToMany<SourceAttributes: Object,
        ...
        Through: Model<ThroughAttributes, any>> extends Association<Source, Target> {
  ...
  deferrable: Sequelize.Deferrable.SET_DEFERRED
     ...
     */
    declare export type FindOptionsAttributesArray<TAttributes> = Array<$Keys<TAttributes> |
        literal |
        [fn, string] |
        [cast, string] |
        [literal, string] |
     ...
     */
         ...
         * @param options Options for the association
         */
        static belongsToMany<TargetAttributes: Object,
            TargetInitAttributes: Object,
            Target: Model<TargetAttributes, TargetInitAttributes>,
            ThroughAttributes: Object,
        ...
        ): BelongsToMany<TAttributes, TInitAttributes, this,
